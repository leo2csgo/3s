...
exports.main = async (event, context) => {
  ...
  try {
    switch (action) {
      ...
      case 'create': {
        ...
        const data = {
          ...
          coverImage: tripInfo.coverImage || '',
      ...
      case 'stats': {
        ...
        const poiCount = list.reduce((sum, t) => sum + (t.blocks || []).filter((b) => b.type === 'poi').length, 0);
    ...
    return { code: 500, msg: 'internal error', error: String(err && err.message || err) };
  }
};
